...
import org.forkjoin.apikit.wrapper.JavaAndroidMessageWrapper;
    ...
    private void buildJavaMessage(final String srcPath, final String rootPackage) {
        new JavaMessageBuilder(
            ...
            protected BuilderWrapper getUtils(MessageInfo info) {
                JavaAndroidMessageWrapper utils = new JavaAndroidMessageWrapper(config, modelInfo, info, rootPackage);
