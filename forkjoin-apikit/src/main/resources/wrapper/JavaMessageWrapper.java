 ...
 */
public class JavaMessageWrapper extends JavaWrapper {
    private MessageInfo messageInfo;

    public JavaMessageWrapper(Config config, ModelInfo modelInfo, MessageInfo messageInfo, String rootPackage) {
