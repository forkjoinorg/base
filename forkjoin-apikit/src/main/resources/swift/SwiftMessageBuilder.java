...
public class SwiftMessageBuilder extends SwiftBuilder<MessageInfo> {
    ...
    protected BuilderWrapper getUtils(MessageInfo info) {
        return new SwiftMessageWrapper(config, modelInfo, info, rootPackage);
    }

//    @Override
//    protected void executeModule(BuilderWrapper utils, MessageInfo moduleInfo, String templPath) throws IOException, ParseException {
...
//
//        HttlUtils.renderFile(implFile, parameters, getImplementationTemplPath(), true);
//    }
...
//    protected File getImplementationFileName(BuilderWrapper utils, MessageInfo moduleInfo) {
