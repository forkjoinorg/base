 ...
 */
public class SwiftApiWrapper extends SwiftWrapper {
    private String messagePackage;

    public SwiftApiWrapper(Config config, ModelInfo modelInfo, ApiInfo apiInfo, String rootPackage, String messagePackage) {
