package com.forkjoin.util.collect;
...
public class ConcurrentSingleArrayBag<E> implements  List<E>, RandomAccess,
	...
	private static class COWIterator<E> implements ListIterator<E> {
		 ...
		 *             always; <tt>remove</tt> is not supported by this
		 *             iterator.
		 */
		public void remove() {
			throw new UnsupportedOperationException();
		 ...
		 * 
		 * @throws UnsupportedOperationException
		 *             always; <tt>set</tt> is not supported by this iterator.
		 */
		public void set(E e) {
			throw new UnsupportedOperationException();
		}
		 ...
		 * 
		 * @throws UnsupportedOperationException
		 *             always; <tt>add</tt> is not supported by this iterator.
		 */
		public void add(E e) {
			throw new UnsupportedOperationException();
		}
