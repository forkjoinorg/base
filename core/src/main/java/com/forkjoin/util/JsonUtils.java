...
import com.forkjoin.core.type.GsonBytesTypeAdapter;
...
public class JsonUtils {
    ...
    public static final String FORMAT_PATTERN = DateTimeUtils.FORMAT;//"yyyy-MM-dd HH:mm:ss";
...
//		mapper.configure(SerializationFeature.WRITE_EMPTY_JSON_ARRAYS , false);
    ...
    public static <T> T gsonDeserialize(String json, Type type) {
