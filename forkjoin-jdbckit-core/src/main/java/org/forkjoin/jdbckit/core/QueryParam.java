...
//	}
	...
	public QueryParam(Field key, Object value) {
		this.key = key;
		this.value = value;
	}
	
	public QueryParam(Field key, Object value,OperatorType opt) {
		this.key = key;
		this.value = value;
		this.opt = opt;
	}

	public QueryParam(Field key, Object value,OperatorType opt, boolean and) {
		this.key = key;
		this.value = value;
		this.opt = opt;
		this.and = and;
	}
	public QueryParam(Field key, Object value,OperatorType opt, boolean and,boolean not) {
		this.key = key;
		this.value = value;
		this.opt = opt;
		this.and = and;
