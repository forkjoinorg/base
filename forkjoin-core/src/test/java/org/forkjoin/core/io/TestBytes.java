...
//        http://qiniuphotos.qiniudn.com/gogopher.jpg?watermark/2/text/5LiD54mb5LqR5a2Y5YKo/font/6buR5L2T/fontsize/1000/fill/I0ZGMDAwMA/dissolve/85/gravity/SouthEast/dx/20/dy/20
        System.out.println(Base64.encodeBase64URLSafeString("黑体".getBytes("utf8")));
        System.out.println(Base64.encodeBase64URLSafeString("#FF0000".getBytes("utf8")));
//		byte b = (byte) 200;
