 ...
 */
public class TestObjectList<T extends ApiMessage> implements ApiMessage {
	...
	public TestObjectList(String id, boolean booleanValue, int intValue, long longValue, float floatValue,
			...
			List<TestObjectList<T>> genericObjs, List<TestObjectList<User>> genericUsers, TestObjectList<T> genericObj,
			T generic) {
		this.id = id;
	...
	public List<Entry<String, Object>> encode(String $parent, List<Entry<String, Object>> $list) {
		...
		if (bytesValue != null && (!bytesValue.isEmpty())) {
