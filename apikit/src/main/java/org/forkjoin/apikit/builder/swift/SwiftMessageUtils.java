 ...
 */
public class SwiftMessageUtils extends SwiftUtils {
    private MessageInfo messageInfo;

    public SwiftMessageUtils(Config config, ModelInfo modelInfo, MessageInfo messageInfo, String rootPackage) {
