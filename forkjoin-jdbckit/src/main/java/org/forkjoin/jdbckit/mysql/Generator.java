...
import org.forkjoin.jdbckit.mysql.create.*;
...
public class Generator {
    ...
    public Generator(Config config, Connection conn) throws SQLException {
        this.config = config;
        //this.conn=conn;
        //初始化
        log.info("初始化数据库信息");
    ...
    public void objectMetaCreate() throws Exception {
        ObjectMetaCreate.create(list, config, config.getObjectPack(), config.getObjectPack() + ".meta");
    }
